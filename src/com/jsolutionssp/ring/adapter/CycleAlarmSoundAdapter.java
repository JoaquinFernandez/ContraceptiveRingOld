...
public class CycleAlarmSoundAdapter extends ArrayAdapter<String> {
	...
	public CycleAlarmSoundAdapter(Context context, int itemInitialListview,
			String[] data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		item.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putInt("cycleAlarmSound", position);
				editor.commit();
