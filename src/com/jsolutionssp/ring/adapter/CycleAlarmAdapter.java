...
public class CycleAlarmAdapter  extends ArrayAdapter<String> {
	...
	public CycleAlarmAdapter(Context context, int itemInitialListview,
			String[] data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		item.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putInt("cycleAlarm", position);
				editor.commit();
