...
public class DiaryAlarmSoundAdapter extends ArrayAdapter<String> {
	...
	public DiaryAlarmSoundAdapter(Context context, int itemInitialListview,
			String[] data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		item.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putInt("diaryAlarmSound", position);
				editor.commit();
