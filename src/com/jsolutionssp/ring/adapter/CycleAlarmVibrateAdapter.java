...
public class CycleAlarmVibrateAdapter extends ArrayAdapter<String> {
	...
	public CycleAlarmVibrateAdapter(Context context, int itemInitialListview,
			String[] data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		item.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putInt("cycleAlarmVibrate", position);
				editor.commit();
